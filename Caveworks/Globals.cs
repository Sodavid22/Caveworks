...
namespace Caveworks
{
    public static class Globals // all global variables
    {
        ...
        public static Vector4 InventoryButtonColor { get; set; } = new Vector4(0, 0.8f, 1, 1); // default color
        public static Vector4 InventoryBoxColor { get; set; } = new Vector4(0, 0.8f, 1, 1); // default color
