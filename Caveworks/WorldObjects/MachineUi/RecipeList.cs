...
namespace Caveworks
{
    static class RecipeList
    {
        ...
        // tools
        public static Recipe PickaxeStone = new Recipe(new BaseItem[1] { new RawStoneItem(8) }, new PickaxeStone(1), 2);


        // recipe lists
        public static List<Recipe> PlayerRecipes = new List<Recipe> { StoneFurnace, Fireplace, IronChest, PickaxeStone };
        public static List<Recipe> AssemblingMachineRecipes = new List<Recipe> { StoneFurnace, Fireplace, IronChest, PickaxeStone, IronGear, CopperWire, GreenCircuit, AssemblingMachine, Drill, ResearchLab, ElectricLight, SlowBelt, CrossRoad, Splitter};
        public static List<Recipe> StoneFurnaceRecipes = new List<Recipe> { IronSmelting, CopperSmelting };
    }
}
