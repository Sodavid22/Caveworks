...
{
    [Serializable]
    public class AsseblingMachineItem : BaseItem
    {
        public AsseblingMachineItem(Tile tile, MyVector2 position, int count) : base(tile, position, count) { }
        public AsseblingMachineItem(int count) : base(count) { }
        ...
        {
            return Textures.AssemblingMachine;
        }
        ...
        public override bool PrimaryUse(MyVector2Int itemRotation)
        {
            ...
            if (canPlace)
            {
                new AsssemblingMachine(Globals.World.GetTileByRelativePosition(tile, new MyVector2Int(-1, -1)));
